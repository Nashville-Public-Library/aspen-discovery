{strip}
	<div id="main-content" class="col-sm-12">
		<h1>{translate text="Talpa Dashboard" isAdminFacing=true}</h1>
		{include file="Admin/selectInterfaceForm.tpl"}
		<div class="row">
			<div class="dashboardCategory col-sm-6">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Active Users" isAdminFacing=true} <a href="/Talpa/UsageGraphs?stat=activeUsers&instance={$selectedInstance}" title="{translate text="Show Active Users Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a></h2>
					</div>
				</div>
				<div class="row">
					<div class="col-tn-6">
			...
			<div class="dashboardCategory col-sm-6">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Number of Records Viewed" isAdminFacing=true} <a href="/Talpa/UsageGraphs?stat=numRecordsViewed&instance={$selectedInstance}" title="{translate text="Show Number of Records Viewed Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a></h2>	
					</div>
				</div>
				<div class="row">
					<div class="col-tn-6">
			...
			<div class="dashboardCategory col-sm-6">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Number of Records Clicked" isAdminFacing=true} <a href="/Talpa/UsageGraphs?stat=numRecordsClicked&instance={$selectedInstance}" title="{translate text="Show Number of Records Clicked Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a></h2>	
					</div>
				</div>
				<div class="row">
					<div class="col-tn-6">
			...
			<div class="dashboardCategory col-sm-6">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="dashboardCategoryLabel">{translate text="Total Clicks" isAdminFacing=true} <a href="/Talpa/UsageGraphs?stat=totalClicks&instance={$selectedInstance}" title="{translate text="Show Total Clicks Graph" inAttribute="true" isAdminFacing=true}"><i class="fas fa-chart-line"></i></a></h2>	
					</div>
				</div>
				<div class="row">
					<div class="col-tn-6">
