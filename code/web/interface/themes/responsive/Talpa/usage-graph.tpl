{strip}
	<div id="main-content" class="col-sm-12">
		...
		<div>
			<a id="UsageGraphExport" class="btn btn-sm btn-default" href="/Talpa/AJAX?method=exportUsageData&stat={$stat}&instance={if !empty($instance)}{$instance}{/if}">{translate text='Export To CSV' isAdminFacing=true}</a>
