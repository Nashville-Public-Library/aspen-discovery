...
- Remove unused AppHeader file. (DIS-398) (*MDN*)
...
### Sierra Updates
- When placing holds within Sierra indicate that there is a possible delay of up to 45 seconds before a hold appears on the patron's account. (DIS-208) (*MDN*)
...
- change GroupedWorkDriver loadRelatedRecords to pull from getPickupLocation instead of getHomeLocation (*IT*) (DIS-403)
  - Search Results will Prioritize Preferred pickup location instead of Home Location in display if it is set and different then the Home location as a result of this change. If no preferred pickup location is set then Home Location will be used as before. behavior for Alt pickup 1 and alt pickup 2 will remain unchanged. (*IT*) (DIS-403)
