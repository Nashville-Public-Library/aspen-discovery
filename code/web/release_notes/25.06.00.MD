...
- The "Existing Title Found" check will only run when the ISBN/ISSN/UPC field contains at least one digit; typing punctuation or symbols won’t trigger it. (DIS-868) (*LS*) 
- ISBN/ISSN/UPC input fields immediately strip out any non‐digit characters typed to prevent accidentally input letters or punctuation. (DIS-868) (*LS*)
