...
- The "Existing Title Found" check will only run when the ISBN/ISSN/UPC field contains at least one digit (0–9) or an uppercase "X" in the check-digit position; typing only punctuation or other letters won’t trigger it. (DIS-868) (*LS*)
- ISBN/ISSN/UPC input fields immediately strip out any characters except digits (0–9) or an uppercase "X" to prevent accidentally typing letters or punctuation. (DIS-868) (*LS*)
