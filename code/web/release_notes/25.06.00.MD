...
### User List Updates
- When bulk adding to list do not add duplicates of titles that are already on the list. (DIS-770) (*MDN*) 
...
// kodi
### Side Load Updates
- Added an option for home library side load administration including sharing options and owning library for side load collections (DIS-560) (*KL*)
