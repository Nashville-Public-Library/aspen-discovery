...
- Updated action hooks to ensure that when more progress is added to a user campaign,the progress is added only if it fits within the campaign dates. (DIS-759) (*AB*)
