...
- Upgraded from jQuery 1.11.0 to 3.6.1, jQuery UI to 1.13.2, and jQuery TableSorter to 2.31.3 to leverage latest security patches and performance improvements. (DIS-1234) (*LS*)
...
- Remove redundant code in Admin/collectionSpotlight.tpl and update its jQuery code. (DIS-1234) (*LS*)
