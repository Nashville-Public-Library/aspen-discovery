...
- Properly return default text for title and body when creating ILS Notifications if translations are not provided. (DIS-1314) (*MDN*)
- Add additional information to cron log when fetching ILS Notifications. (DIS-1314) (*MDN*)
...
- Resolved an issue where typing in TableSorter text boxes would detect input but not visually hide/show table rows. (DIS-1234) (*LS*)
