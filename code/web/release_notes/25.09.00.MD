...
### Interface Updates
- When adding new rows to tables, the page now automatically scrolls to show the new row, and empty unsaved rows can be deleted directly without needing to save first. (DIS-1228) (*LS*)
