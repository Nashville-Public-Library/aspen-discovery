...
- Update cron for fetching ILS Account Notifications to run updates. (DIS-84) (*MDN*)
- Correctly show sent notifications with Messaging History. (DIS-84) (*MDN*)
- Allow ILS Notification Settings to be configured in Notification Settings. (DIS-84) (*MDN*)
...
- Make the Notification Access Token within the Greenhouse optional when sending push notifications. (DIS-84) (*MDN*)
