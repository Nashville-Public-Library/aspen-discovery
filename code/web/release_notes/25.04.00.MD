...
//mark
### Display Updates
- Allow alignment of the optional branding logo within LiDA so it can be left justified, center justified, or right justified. (*MDN*, *KK*)
- Allow the background color of the branding logo to be set. (*MDN*)
