...
class Talpa_Home extends Action {
	...
	function launch() {
		...
		$this->recordDriver = new TalpaRecordDriver($id);
		...
		$appearsOnLists = UserList::getUserListsForRecord('Talpa', $this->recordDriver->getPermanentId());
