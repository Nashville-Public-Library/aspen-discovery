...
//						if($tmpResult['success']){$success++;}
	...
	public function getAdminActions() {
		...
		if ($customSelfRegForms) {
			...
			$sections['ils_integration']->addAction(new AdminAction('Review Library Registrations', 'Review and approve self registrations.', '/ILS/ReviewLibraryRegistrations'), ['Administer Self Registration Forms']);
		}
